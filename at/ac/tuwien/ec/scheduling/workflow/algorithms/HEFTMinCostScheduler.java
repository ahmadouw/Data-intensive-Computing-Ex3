...
public class HEFTMinCostScheduler extends WorkflowScheduler {
	
	
	public HEFTMinCostScheduler(MobileApplication A, MobileCloudInfrastructure I) {
		super();
	...
	public HEFTMinCostScheduler(Tuple2<MobileApplication,MobileCloudInfrastructure> t) {
		super();
