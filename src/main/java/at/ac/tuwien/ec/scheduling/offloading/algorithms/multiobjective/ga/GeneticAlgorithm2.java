...
public class GeneticAlgorithm2 extends OffloadScheduler {
    ...
    public GeneticAlgorithm2(Tuple2<MobileApplication, MobileCloudInfrastructure> t) {
        super();
    ...
    public ArrayList<OffloadScheduling> findScheduling() {
        ...
        while (generation < MAX_GENERATIONS) {
            ...
            averageFitness.add(averageFitness(fitness));
    ...
    private double averageFitness(HashMap<Integer, Double> fitness) {
        double sum = 0.0;
        for (double value : fitness.values()) {
            sum += value;
        }
        return sum / fitness.values().size();
    }
